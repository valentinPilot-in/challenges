...
require_once(DUPLICATOR____PATH . '/classes/utilities/tests/class.u.tests.manager.php');
require_once(DUPLICATOR____PATH . '/classes/utilities/tests/class.test.debug.php');
require_once(DUPLICATOR____PATH . '/classes/utilities/tests/class.test.package.build.php');
