...
$this->pages['eu']['privacy-statement']['document_elements'] = array(
    'last-updated' => array(
        'content' => '<i>' . cmplz_sprintf(_x('This privacy statement was last updated on %s and applies to citizens and legal permanent residents of the European Economic Area.', 'Legal document privacy statement', 'complianz-gdpr'), '[publish_date]') . '</i><br>',
    ),
    'inleiding' => array(
        'content' =>
