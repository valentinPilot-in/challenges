...
$this->pages['us']['privacy-statement-children']['document_elements']= array(
    'last-updated' => array(
        'content' => '<i>' . cmplz_sprintf('This privacy statement was last changed on %s, was last checked on %s and applies to citizens and legal permanent residents of the United states.', '[publish_date]', '[checked_date]') . '</i><br>',
    ),
