...
$this->pages['au']['privacy-statement-children']['document_elements'] = array(
    'last-updated' => array(
        'content' => '<i>' . cmplz_sprintf(_x('This Privacy Statement was last changed on %s, was last checked on %s and applies to citizens of Australia.', 'Legal document privacy statement', 'complianz-gdpr'), '[publish_date]', '[checked_date]') . '</i><br>',
    ),

    'inleiding' => array(
        'content' =>
            '<p>'. cmplz_sprintf(_x('In this Privacy Statement, we explain what we do with the data we obtain about children via %s. We recommend you carefully read this statement. In our processing we comply with the requirements of Australian privacy legislation. That means, among other things, that:', 'Legal document privacy statement', 'complianz-gdpr'), '[domain]') .'</p>'.
            '<ul>
    ...
    array(
        ...
        'content' =>
            '<b>'._x('Purpose of the data transfer:', 'Legal document privacy statement', 'complianz-gdpr').'</b>&nbsp;[purpose]<br>
             <b>'._x('Country or state in which this processor is located:', 'Legal document privacy statement', 'complianz-gdpr').'</b>&nbsp;[country]<br>',
        'condition' => array(
            'processor' => 'loop',
