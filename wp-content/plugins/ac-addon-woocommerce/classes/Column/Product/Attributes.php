...
class Attributes extends AC\Column
	...
	public function editing() {
		if ( $this->is_taxonomy_attribute() ) {
			return new Editing\Product\Attributes\Taxonomy( $this->get_attribute() );
		}

		if ( $this->is_custom_attribute() ) {
			return new Editing\Product\Attributes\Custom( $this->get_attribute(), $this->get_setting_attribute()->get_attributes_custom_labels() );
		}
